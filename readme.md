...
> *Ejemplo ilustrativo de la información que puede manejar el sistema.*
...
Cada funcionalidad se desarrolla en su propia rama `feature` y posteriormente se integra a la rama de desarrollo.
